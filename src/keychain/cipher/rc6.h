...
BLACKCAT_CIPHER_ARGS_READER_PROTOTYPE(rc6_128, algo_params, args, args_nr, key, key_size, argc, err_mesg);
BLACKCAT_CIPHER_ARGS_READER_PROTOTYPE(rc6_192, algo_params, args, args_nr, key, key_size, argc, err_mesg);
BLACKCAT_CIPHER_ARGS_READER_PROTOTYPE(rc6_256, algo_params, args, args_nr, key, key_size, argc, err_mesg);
