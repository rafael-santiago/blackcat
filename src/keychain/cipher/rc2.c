...
IMPL_BLACKCAT_CIPHER_PROCESSOR(hmac_blake2s256_rc2, ktask, p_layer,
                               kryptos_run_cipher_hmac(rc2, blake2s256,
                                                       *ktask, p_layer->key, p_layer->key_size, p_layer->mode,
                                                       (int *)p_layer->arg[0]))

IMPL_BLACKCAT_CIPHER_PROCESSOR(hmac_blake2b512_rc2, ktask, p_layer,
                               kryptos_run_cipher_hmac(rc2, blake2b512,
                                                       *ktask, p_layer->key, p_layer->key_size, p_layer->mode,
                                                       (int *)p_layer->arg[0]))
